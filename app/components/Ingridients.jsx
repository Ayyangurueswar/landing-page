...
const Ingridients = () => {
  return (
    <div className='my-12 w-full max-w-[1185px] mx-auto'>
        <div className='flex items-center gap-4'>
            ...
            <div className='bg-[url(/images/h2-b1.jpg.png)] flex flex-col gap-2 p-8 w-[350px] h-[250px] rounded-xl overflow-hidden' style={{backgroundSize: '100% 100%'}}>
            ...
            <div className='bg-[url(/images/bn2-2.jpg.png)] flex flex-col gap-2 p-8 w-[350px] h-[250px] rounded-xl overflow-hidden' style={{backgroundSize: '100% 100%'}}>
                <p className='text-[#004958] font-bold text-xl'>Vitamin C</p>
                <p className='text-slate-500 font-semibold'>Vitamin C as ascorbic acid</p>
                <button className='text-[#004958] underline justify-self-end mt-auto w-1/3 font-bold'>SEE MORE</button>
            </div>
        ...
        <div className='flex items-center gap-4 mt-4'>
            <div className='bg-[url(/images/bn2-3.jpg.png)] flex flex-col gap-2 p-8 w-[350px] h-[250px] rounded-xl overflow-hidden' style={{backgroundSize: '100% 100%'}}>
            ...
            <div className='bg-[url(/images/bn2-4.jpg.png)] flex flex-col gap-2 p-8 w-[350px] h-[250px] rounded-xl overflow-hidden' style={{backgroundSize: '100% 100%'}}>
            ...
            <div className='bg-[url(/images/bn2-5.jpg.png)] flex flex-col gap-2 p-8 w-[350px] h-[250px] rounded-xl overflow-hidden' style={{backgroundSize: '100% 100%'}}>

...
const About = () => {
  return (
    <div className='w-full bg-blue-100 rounded-tl-[20%] py-24 px-16 flex flex-col gap-32'>
        <div className='flex items-center justify-between w-full max-w-[1185px] mx-auto'>
            <Image src='/images/Picture-4-1.png.png' alt='' width={600} height={700} className='h-[550px]'/>
            <div className='flex flex-col gap-6 w-2/5'>
                <h2 className='text-[#004958] font-bold'>ABOUT EVE PHARMACY</h2>
                <p className='text-5xl text-[#004958] font-bold w-3/5'>Supercharge Your Health</p>
                ...
                <p className='font-semibold w-3/4 text-lg mt-3'>We offer choice, reliability and value That&apos;s what makes us better</p>
                <button className='bg-[#004958] text-white font-semibold py-4 px-6 w-2/5 rounded-full'>ABOUT US</button>
            </div>
        </div>
        <div className='flex items-center justify-between w-full max-w-[1185px] mx-auto'>
            <div className='flex flex-col gap-4 w-2/5'>
                ...
                <p className='text-5xl text-[#004958] font-bold w-5/6'>Feel Better Or Your Money Back</p>
                ...
                <button className='text-[#004958] bg-white border-[#004958] border font-semibold mt-4 py-4 px-6 w-2/5 rounded-full'>EXPLORE NOW</button>
            </div>
            <Image src='/images/Picture5.png.png' alt='' width={650} height={800}/>
        </div>
        <div className='flex items-center justify-between w-full max-w-[1185px] mx-auto'>
            <div className='flex'>
                <div className='w-64 h-64 rounded-full bg-sky-300 flex justify-between items-center z-10'>
                    <div className='w-5 h-5 rounded-full bg-[#8da8d0] -ml-2'></div>
                    <Image src='/images/product-3.png.png' alt='' width={700} height={700} className='w-[220px] h-[280px] -mt-8 ml-4'/>
                ...
                <div className='flex flex-col gap-6 -ml-6 mt-6'>
                    ...
                    <div className='bg-white px-6 py-14 rounded-3xl flex flex-col gap-4'>
                        ...
                        <button className='underline text-[#004958] w-1/2 text-left font-bold'>ALL REVIEWS</button>
                    </div>
                </div>
            </div>
            <div className='flex flex-col gap-4 w-1/2'>
                <h2 className='text-[#004958] font-bold'>BEST OFFERS</h2>
                <p className='text-5xl text-[#004958] font-bold w-5/6'>Start Feeling Better</p>
                ...
                <button className='bg-[#004958] text-white font-semibold py-4 px-6 w-2/5 rounded-full'>BUY NOW</button>
            </div>
        </div>
    </div>
  )

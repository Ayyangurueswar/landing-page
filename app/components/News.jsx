...
const News = () => {
  return (
    <div className='w-full max-w-[1185px] mx-auto my-10'>
        ...
        <div className='grid lg:grid-cols-4 sm:grid-cols-2 max-lg:gap-y-5 mt-4'>
            <div className='w-[250px] h-[350px] bg-[url(/images/blog1-450x580.jpg.png)] rounded-xl relative m-auto' style={{backgroundSize: '100% 100%'}}>
            ...
            <div className='w-[250px] h-[350px] bg-[url(/images/blog2-450x580.jpg.png)] lg:mt-32 rounded-xl relative m-auto' style={{backgroundSize: '100% 100%'}}>
                <div className='bg-indigo-800 text-white px-6 py-1 rounded-r-full absolute top-4 -left-3 text-sm'>20 APR</div>
                <h2 className='text-white w-4/5 mx-auto mt-14 font-bold'>The Covid 19 Epidemic In 2022 Is Back</h2>
            </div>
            <div className='w-[250px] h-[350px] bg-[url(/images/blog1-450x580.jpg.png)] rounded-xl relative m-auto' style={{backgroundSize: '100% 100%'}}>
